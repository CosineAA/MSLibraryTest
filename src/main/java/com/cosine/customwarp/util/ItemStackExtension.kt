...
fun ItemStack.toByteArrayCompress(): ByteArray = compressByteArray(toByteArray())
@JvmName("toByteArrayCompressNullableItemStack")
fun ItemStack?.toByteArrayCompress(): ByteArray = compressByteArray(ItemStack(Material.AIR).toByteArray())
@JvmName("toByteArrayCompressNullableItemStack")
fun Array<ItemStack?>.toByteArrayCompress(): ByteArray = compressByteArray(toByteArray())
...
@Throws(ByteArrayCastException::class)
fun ByteArray.toItemArrayDecompress(): Array<ItemStack> {
    val result: Array<ItemStack>
    try {
